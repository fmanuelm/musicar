...
import { Client, DatosContacto } from '../interfaces/Client.interface';
...
export class CreateComponent implements OnInit {
  ...
  constructor(private clientService: ClientsService, private _formBuilder: FormBuilder) {
  ...
  sendForm() {
    if (this.form.invalid) {
      ...
      this.clientSend.paises = clientTemp.paises;
      this.clientSend.subgrupo_economico = clientTemp.subgrupo_economico;
      this.clientSend.tipo_cliente = clientTemp.tipo_cliente;
      this.clientSend.usuario_comercial = clientTemp.usuario_comercial;
      this.clientSend.horarios.lunes.hora_inicial = clientTemp.lunes_hora_inicial;
